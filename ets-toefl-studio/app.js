...
const classBoardTasks = [
  ...
  },
  {
    ...
    teacher: "김정윤",
    posted: "2026.06.08",
    title: "정규후반부 Day 2 수업 자료",
    tasks: [
      "첨부 PDF 2606_정규후반부_DAY2-protected.pdf 열기",
      "수업 시간에 안내되는 비밀번호로 자료 확인",
      "예습하지 말고 수업 시간에 열어보는 자료로 표시",
      "수업 후 Reference 문제 풀이와 연결해 근거 문장 표시",
    ],
    note: "보호된 PDF입니다. 비밀번호는 수업 시간에만 안내된다고 공지되어 있습니다.",
    url: "https://www.hackers.ac/class-board/HackersTOEFL_1/7740890?no_lesson=469813&jijum=1001&cat=&opendays=&p=1",
    attachmentUrl: "https://www.hackers.ac/attachment/download/3481871",
    attachmentName: "2606_정규후반부_DAY2-protected.pdf",
    passwordLabel: "Reading PDF password saved",
    password: "mignon29@@",
  },
  {
    ...
    teacher: "김정윤",
    posted: "2026.06.08",
    title: "정규후반부 Day 2 숙제",
    tasks: [
      "주교재 Task 3 Reference p.236-245 풀이 및 리뷰",
      "Hackers Vocabulary Day 19-20 한글 의미 암기",
      "Hackers Vocabulary Day 19-20 동의어 암기",
      "다음 시간 쪽지시험 대비 15개 단어 복습",
      "다음 수업부터 사용할 노트북 또는 태블릿 지참",
    ],
    note: "자료 비밀번호는 수업 시간에만 안내. 문의는 이메일로 처리한다고 공지되어 있습니다.",
    url: "https://www.hackers.ac/class-board/HackersTOEFL_1/7741581?no_lesson=469813&jijum=1001&cat=&opendays=&p=1",
  },
  {
    subject: "WRT",
    day: "Day 2",
    ...
    title: "DAY 2 진도 및 과제",
    tasks: [
      "수업 진도: 주교재 p.187-195 구문영작 확인",
      "수업 진도: 주교재 p.270-271 확인",
      "수업 진도: 부교재 p.78-84 확인",
      "숙제: 주교재 p.196-205 구문영작 완료",
      "숙제: 주교재 p.272-279 의견쓰기 완료",
      "숙제: 부교재 p.84까지 완료",
    ],
    note: "구문영작과 의견쓰기를 분리해 완료 체크하면 Writing 복습 흐름이 선명해집니다.",
    url: "https://www.hackers.ac/class-board/HackersTOEFL_1/7741096?no_lesson=469813&jijum=1001&cat=&opendays=&p=1",
  },
  {
    subject: "SPK",
    day: "Day 2",
    ...
    tasks: [
      "첨부된 Day 2 숙제 문서 열기",
      "문서의 숙제 항목을 Speaking 워크스페이스에 옮겨 체크",
      "수업 중 녹음/피드백 내용을 복습 메모로 정리",
      "다음 수업 전 Listen & Repeat 정확도와 억양 재점검",
    ],
    note: "첨부 문서의 원문 내용은 앱에 복제하지 않고, 바로 열 수 있는 링크와 복습 행동만 정리했습니다.",
    url: "https://www.hackers.ac/class-board/HackersTOEFL_1/7741514?no_lesson=469813&jijum=1001&cat=&opendays=&p=1",
    attachmentUrl: "https://www.hackers.ac/attachment/download/3482037",
    attachmentName: "6월 오후 정규 B - Day 2.doc",
  },
  {
    subject: "LC",
    day: "Day 2",
